...
void main( void)
{
    ...
    float fdrop=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.15,-0.15+0.1*sin(2.5*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.05,-0.25+0.15*sin(2.8*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.05,-0.15+0.1*sin(3.1*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.15,-0.15+0.15*sin(3.2*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.25,-0.25+0.1*sin(3.3*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.25,-0.25+0.1*sin(3.4*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.35,-0.25+0.15*sin(3.5*iTime)),0.03,0.01,0.04));
