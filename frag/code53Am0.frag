...
void main( void)
{
    ...
    float fdrop=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.0,-0.1+0.1*sin(2.5*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.1,-0.1+0.1*sin(2.8*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.2,-0.1+0.1*sin(3.1*iTime)),0.03,0.01,0.04));
