...
void main( void)
{
    ...
    float fdrop=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.0,-0.4+0.1*sin(5.1*iTime)),0.04,0.015,0.05));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.1,-0.4+0.1*sin(5.3*iTime)),0.04,0.015,0.05));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.2,-0.4+0.1*sin(5.5*iTime)),0.04,0.015,0.05));
