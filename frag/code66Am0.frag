...
void main( void)
{
    ...
    fdrop+=1.0-smoothstep(0.0,0.02,sdTriangleIsosceles(uv-vec2(-0.2,-0.45),vec2(0.05,-0.08)));
    fdrop+=1.0-smoothstep(0.0,0.02,sdTriangleIsosceles(uv-vec2(-0.1,-0.48),vec2(0.04,-0.05)));
