...
void main( void)
{
    ...
    float fdrop=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.0,-0.4+0.1*sin(2.0*iTime)),0.03,0.01,0.04));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.2,-0.4+0.1*sin(2.1*iTime)),0.03,0.01,0.04));

    fdrop+=1.0-smoothstep(0.0,0.02,sdTriangleIsosceles(uv-vec2(-0.2,-0.45),vec2(0.045,-0.08)));
    fdrop+=1.0-smoothstep(0.0,0.02,sdTriangleIsosceles(uv-vec2(-0.1,-0.48),vec2(0.035,-0.05)));
