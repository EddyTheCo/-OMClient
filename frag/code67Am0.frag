...
void main( void)
{
    ...
    float fcloud=cloud(uv,vec2(-0.1,0.05)+
    ...
    float fdrop=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.15,-0.15+0.1*sin(5.1*iTime)),0.04,0.015,0.05));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.05,-0.25+0.15*sin(5.3*iTime)),0.04,0.015,0.05));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.05,-0.15+0.1*sin(5.5*iTime)),0.04,0.015,0.05));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.15,-0.15+0.15*sin(5.7*iTime)),0.04,0.015,0.05));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(-0.25,-0.25+0.1*sin(5.9*iTime)),0.04,0.015,0.05));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.25,-0.25+0.1*sin(6.1*iTime)),0.04,0.015,0.05));
    fdrop+=1.0-smoothstep(-0.01,0.01,sdUnevenCapsule(uv-vec2(0.35,-0.25+0.15*sin(6.3*iTime)),0.04,0.015,0.05));

    fdrop+=1.0-smoothstep(0.0,0.02,sdTriangleIsosceles(uv-vec2(-0.1,-0.35),vec2(0.045,-0.08)));
    fdrop+=1.0-smoothstep(0.0,0.02,sdTriangleIsosceles(uv-vec2(-0.0,-0.38),vec2(0.035,-0.05)));
    fdrop+=1.0-smoothstep(0.0,0.02,sdTriangleIsosceles(uv-vec2(0.1,-0.35),vec2(0.045,-0.08)));
    fdrop+=1.0-smoothstep(0.0,0.02,sdTriangleIsosceles(uv-vec2(0.2,-0.38),vec2(0.035,-0.05)));
    fdrop=clamp(0.0,1.0,fdrop);
